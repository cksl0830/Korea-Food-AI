...
def get_image():
    file='/content/drive/MyDrive/자기 drive folder/drivefile'
...
def kakao_ocr_resize(image_path: str):
    """
    ocr api의 제약사항이 넘어서는 이미지는 요청 이전에 전처리 
    pixel 제약사항 초과: resize
    용량 제약사항 초과  : 다른 포맷으로 압축, 이미지 분할 등의 처리 필요
...
def main():
    ...
    if resize_impath is not None:
        ...
        print("원본 대신 Resize된 이미지를 사용합니다.")
